...
public class SimpleTests {
	...
	public static void main(String args[]) {
		 ...
		 * blocks.get(0).getLength() + ", expected is 2."); System.out.println();
		 * 
		 * 
		 * System.out.println("Making board with testGrid1."); Board board = new
		 * Board(testGrid1, makeTest1Blocks()); System.out.println(board.toString());
		 * System.out.println();
		 * 
		 * board.grabBlockAtCell(2, 1); System.out.println("Grabbed block " +
		 * board.getGrabbedBlock()); System.out.println("Location of grab is at (" +
		 * board.getGrabbedCell().getRow() + ", " + board.getGrabbedCell().getCol() +
		 * ") " + ", expected (2, 1)."); System.out.println();
		 * 
		 ...
		 * System.out.println(board.toString()); System.out.println();
		 * 
		 * board.reset(); System.out.println("After reset:");
		 * System.out.println(board.toString()); System.out.println();
		 * 
